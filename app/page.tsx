...
const HomePage = () => {
  const { user, logout, openModal } = useUser();
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveIndex2((prevIndex) => (prevIndex + 1) % headings2.length);
    }, 2000);
    return () => clearInterval(interval);
  }, [headings2.length]);
        ...
        <div className="row">
          <div className="nav__wrapper">
            <figure className="nav__img--mask">
              <img className="nav__img" src="/logo.jpeg" alt="logo" />
            </figure>
            <ul className="nav__list--wrapper">
              {user ? (
                <li className="nav__list nav__list--logout" onClick={logout}>Logout</li>
              ) : (
        ...
        <div className="row">
          <div className="landing__wrapper">
            ...
            <figure className="landing__image--mask">
              <img src="/landing.jpeg" alt="landing" />
            </figure>
          </div>
        </div>
              ...
              >
                {headings2.map((heading, index) => (
                  <div
                    key={index}
                    className={`statistics__heading ${
                      index === activeIndex2 ? "statistics__heading--active" : ""
                    }`}
                  >
                    {heading}
                  </div>
